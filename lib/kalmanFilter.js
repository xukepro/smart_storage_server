...
KF.prototype = {
  ...
  'update': function (ob) {
    // u: Linear input variable
    let u = Object.prototype.hasOwnProperty.call(ob, 'u') ? math.matrix(ob.u) : [0, 0];

    // z: obsversion input variable
    let z = Object.prototype.hasOwnProperty.call(ob, 'z') ? math.matrix(ob.z) : [0, 0];

    // R: Sensor Noise Covariance
    this.R = Object.prototype.hasOwnProperty.call(ob, 'R') ? ob.R : this.R;

    // Step1:
    // x_k: Predicted State vector / Estimated signal
    let x_k = math.add(this.x, math.multiply(this.G, u));
    // console.log('1: x: ' + x_k);
